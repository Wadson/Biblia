...
public sealed class SettingsViewModel:INotifyPropertyChanged
{
    ...
    private async Task SaveBackupAsAsync()=>await RunAsync(async()=>{LastBackup=await _backup.CreateAsync();await _files.SaveCopyAsync(LastBackup.Path);Status="Cópia do backup salva com sucesso.";});
